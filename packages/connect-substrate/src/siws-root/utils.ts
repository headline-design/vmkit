 ...
 */
export const serializeSiwsMessage = (message: SiwsMessage): string => {
  return `Message:
...
export const VerifySiwsParamsKeys: Array<keyof VerifyParams> = [
  'signature',
  'address',
  'domain',
  'scheme',
...
export interface VerifySiwsOpts {
...
export const VerifySiwsOptsKeys: Array<keyof VerifySiwsOpts> = [
  'suppressExceptions',
  'verificationFallback',
];
