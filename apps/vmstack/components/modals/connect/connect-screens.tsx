import { SubstrateConnect } from "./substrate-connect";
import SIWSolConnect from "./siwsol/siwsol-connect";
...
export const SubstrateWalletsScreen = () => {
